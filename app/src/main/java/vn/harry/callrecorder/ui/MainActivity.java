...
import vn.harry.callrecorder.ui.clientsFragment.ClientsFragment;
import vn.harry.callrecorder.ui.login.LoginActivity;
...
public class MainActivity extends BaseActivity
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new AllCallFragment(), getString(R.string.home));
        adapter.addFrag(new ClientsFragment(), getString(R.string.clients_tab));
